...
- [x] 6.1 Run the focused Controlled Development Rust integration target and frontend tests, and record the exact observed counts and results.
<!-- status: completed -->
- [x] 6.2 Run `cargo fmt --all -- --check`.
<!-- status: completed -->
- [x] 6.3 Run `cargo check --workspace`.
<!-- status: completed -->
- [x] 6.4 Run `cargo clippy --workspace -- -D warnings`.
<!-- status: completed -->
