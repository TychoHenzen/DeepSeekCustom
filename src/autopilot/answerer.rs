...
fn build_prompt(policy_section: &str, input: &AskInput) -> String {
...
fn parse_reply(reply: &str) -> Option<Vec<Answer>> {
...
fn resolve_answers(parsed: Option<Vec<Answer>>, input: &AskInput) -> Vec<Answer> {
...
mod tests {
    use super::*;
    use crate::autopilot::question::{Question, QuestionOption};
